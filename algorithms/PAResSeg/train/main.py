...
from algorithms.PAResSeg.train.trainer import run_training
from dataset.datasets import get_loader_2D_simple

from monai.inferers import sliding_window_inference
from monai.losses import DiceCELoss
from monai.metrics import DiceMetric
from algorithms.PAResSeg.network.phase_att import RESNET_phase_att as PAResSeg
from monai.transforms import Activations, AsDiscrete, Compose
from monai.utils.enums import MetricReduction
from utils.utils import info_if_main, load_model, logger_info
from loguru import logger
from utils.utils import layer_infer
...
def main_worker(gpu, args):
    ...
    loader = get_loader_2D_simple(args)
    ...
    model_inferer = partial(
        layer_infer,
        model = model,
        output_channel = args.out_channels
    )
