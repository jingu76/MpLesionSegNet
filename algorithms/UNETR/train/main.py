...
parser.add_argument("--sw_batch_size", default=1, type=int, help="number of sliding window batch size(window size)")
...
def main_worker(gpu, args):
    ...
    elif args.loss == "DiceBD":
        dice_loss = DiceBDLoss(to_onehot_y=True, softmax=True, include_background=False)
    else:
