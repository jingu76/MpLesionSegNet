...
def window_partition(x, window_size):
    ...
    if len(x_shape) == 5:
        ...
        windows = (  # b, d/ws, h/ws, w/ws, ws, ws, ws, c -> b * d/ws * h/ws * w/ws, ws * ws * ws, c
...
class SwinTransformer(nn.Module):
    ...
    def __init__(
        ...
        for i_layer in range(self.num_layers):
            ss = self.window_size[0]//2
            if i_layer == 0:
                shift_size=[(0,0,0),(0,0,ss),(0,ss,0),(0,ss,ss),(ss,0,0),(ss,0,ss),(ss,ss,0),(ss,ss,ss)]
            elif i_layer == 1:
                shift_size=[(0,0,0),(ss,ss,0),(ss,0,0),(0,ss,0)]
            elif i_layer == 2:
                shift_size=[(0,0,0),(ss,ss,0)]
            elif i_layer == 3:
