...
class SwinUNETR_Four(nn.Module):
    ...
    def __init__(
        ...
        self.fusion10 = MultiPhaseFusion(in_channel=768, heads=48)
    ...
    def forward(self, x_in):
        ...
        enc4 = self.encoder5(hidden_states_out[3][:, 2])
        fusion = self.fusion10(hidden_states_out[4][:, 0],
                               hidden_states_out[4][:, 1],
                               hidden_states_out[4][:, 2],
                               hidden_states_out[4][:, 3])
        dec4 = self.encoder10(fusion)
