...
from algorithms.SwinUNETR.train.trainer_four_weight import run_training
from dataset.datasets import get_loader_mp_weight

from monai.inferers import sliding_window_inference
from monai.losses import DiceCELoss
from monai.metrics import DiceMetric
from algorithms.SwinUNETR.network.swin_unetr_resswin_skipadd_s_3fusion import SwinUNETR_Four
from monai.transforms import Activations, AsDiscrete, Compose
from monai.utils.enums import MetricReduction
from utils.utils import info_if_main, load_model, logger_info
from loguru import logger

from loss.medloss import MedLoss

parser = argparse.ArgumentParser(description="Swin UNETR segmentation pipeline")
parser.add_argument("--checkpoint", default=None, help="start training from saved checkpoint")
parser.add_argument("--logdir", default="/data4/ycy/experiment/test", type=str, help="directory to save the tensorboard logs")
parser.add_argument(
...
def main_worker(gpu, args):
    ...
    loader = get_loader_mp_weight(args)
    ...
    dice_loss = MedLoss(to_onehot_y=True, softmax=True, include_background=False)
